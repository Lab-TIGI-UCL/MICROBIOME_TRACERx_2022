...
p + stat_compare_means() + scale_fill_manual(values = c("deeppink3", "deepskyblue4")) + xlab("Microbial Load Class") +ylab("Immune Hotspot - fi") +ylim(0, 1) +theme(axis.title.x = element_text(size = rel(2)), 
