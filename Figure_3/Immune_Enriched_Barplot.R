...
absolute_counts <- absolute_counts %>% filter(total > 4)
...
to_keep <- c("Tissierella", "UCG-005","Alistipes", "unidentified_Xanthobacteraceae", "Akkermansia", "Alicycliphilus", "Lachnospiraceae_NK4A136_group", "Collinsella", "Peptoniphilus", "Alloprevotella", 
             "unidentified_Micrococcaceae", "CAG-352", "Clostridia_UCG-014",
             "Escherichia-Shigella", "Atopostipes", "Family_XIII_AD3011_group", "Bryobacter", "Streptomyces", "[Eubacterium]_coprostanoligenes_group", "[Ruminococcus]_torques_group", "Shimwellia", "Lysobacter", 
             "Campylobacter", "Corynebacterium", "Sphingobacterium", "Lachnoclostridium"
             )
