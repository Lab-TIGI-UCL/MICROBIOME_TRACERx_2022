...
# Loading data
absolute_counts <- read.csv("~/normalised_full.csv", header = TRUE, check.names = FALSE) %>% as.data.frame()
...
taxmat <- readRDS("~/QIIME2_pipeline/Tx_data/taxmat.rds") %>% as.data.frame()
